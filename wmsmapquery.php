...
<body>
	...
	<table style="text-align:left;width:255px;padding:0px;font-size:.9em;">
...
<?
	...
	//<img src="http://www.geochron.org/iedageochronlogo.jpg">
...
?>
  	...
  	<tr>
    	<td bgcolor="#FFFFFF">
      	<table style="line-height:110%;">

<?

if($myrow->upstream=="t"){
	if($myrow->sample_id!=""){?><tr><td><b>SampleID:</b></td><td><?=strtoupper($myrow->sample_id)?></td></tr><?}
	if($showdetritalmethod!=""){?><tr><td><b>Detrital Method:</b></td><td><?=$showdetritalmethod?></td></tr><?}
	if($showdetritalmethod!=""){?><tr><td><b>Detrital Mineral:</b></td><td><?=$myrow->material?></td></tr><?}
	if($myrow->detrital_type!=""){?><tr><td><b>Detrital Rock Type:</b></td><td><?=$myrow->detrital_type?></td></tr><?}
	if($myrow->age_min!=""){?><tr><td><b>Min. Strat Age:</b></td><td><?=$myrow->age_min?> Ma</td></tr><?}
	if($myrow->age_max!=""){?><tr><td><b>Max. Strat Age:</b></td><td><?=$myrow->age_max?> Ma</td></tr><?}
	if($myrow->strat_name!=""){?><tr><td><b>Stratigraphic<br>Formation Name:</b></td><td><?=$myrow->strat_name?></td></tr><?}
	if($myrow->oldest_frac_date!=""){?><tr><td><b>Oldest Frac. Date:</b></td><td><?=round($myrow->oldest_frac_date/1000000, 3)?> Ma</td></tr><?}
	if($myrow->youngest_frac_date!=""){?><tr><td><b>Youngest Frac. Date:</b></td><td><?=round($myrow->youngest_frac_date/1000000,3)?> Ma</td></tr><?}
}else{
...
?>
<tr><td colspan="2"><div align="center"><a style="color:#3333CC;font-size:8pt;font-weight:bold; " href="http://www.geochron.org/viewfile.php?pkey=<?=$myrow->sample_pkey?>" target="_blank"><img src="http://www.geochron.org/magglass.png" border="0"> VIEW SAMPLE DETAILS</a></div><br></td></tr>
<?
}else{
?>
...
?>
	...
	<tr>
		<td colspan="2">
			...
			<?
			if(file_exists("concordiasd/sidebar/$sample_pkey.jpg") && $newsample_pkey!=""){
			?>
			...
			<div id="concordiatab" style="padding:2px;
							...
							border:1px solid;
							color:#000000;
							background:#EEEEEE;">Concordia&nbsp;Diagram</div>			
			<div style="clear:left;"></div>

			<div id="" style="border:1px solid;">
				<div id="concordiadiv">
						<img src="http://www.geochron.org/concordias/sidebar/<?=$sample_pkey?>.jpg" border="0">
				</div>
			</div>
			...
			<?
			if(file_exists("probabilitiesd/sidebar/$sample_pkey.jpg") && $newsample_pkey!=""){
			?>
			...
			<div id="probabilitytab" style="padding:2px;
							...
							border:1px solid;
							color:#000000;
							background:#EEEEEE;">Probability&nbsp;Diagram</div>			
			<div style="clear:left;"></div>

			<div id="" style="border:1px solid;">
				<div id="probabilitydiv">
						<img src="http://www.geochron.org/probabilities/sidebar/<?=$sample_pkey?>.jpg" border="0">
				</div>
			</div>
...
if($conc=="yes"){
	...
	$mapstring="select 
				...
				and ST_Contains(GeomFromText('Polygon(($coordbox))'), mypoint)
				and del=0 
				group by
				samp.sample_pkey,
				samp.sample_id";
		...
		<td colspan="2">
			...
			<div id="" style="border:1px solid;">
				<div id="concordiadiv">
					...
					?>
					<a href="javascript:popconcordia('http://www.geochron.org/viewconcordia.php?sample_pkey=<?=$sample_pkey?>');" >
				...
				<div id="probabilitydiv" style="display:none;">
					...
					?>
					<a href="javascript:popconcordia('http://www.geochron.org/viewprobability.php?sample_pkey=<?=$sample_pkey?>');" >
...
<tr><td colspan="2"><div align="center"><a style="color:#3333CC;font-size:8pt;font-weight:bold; " href="http://www.geochron.org/viewfile.php?pkey=<?=$myrow->sample_pkey?>" target="_blank"><img src="http://www.geochron.org/magglass.png" border="0"> VIEW SAMPLE DETAILS</a></div></td></tr>
<?
