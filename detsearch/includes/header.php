...
if($scriptname=="/index.php"){
	...
	$apiactive="active";
}elseif($scriptname=="/download.php" || $scriptname=="/requestaccess.php"){
	$appactive="active";
...
<link rel="apple-touch-icon" sizes="57x57" href="/bicons/apple-icon-57x57.png">
<link rel="apple-touch-icon" sizes="60x60" href="/bicons/apple-icon-60x60.png">
<link rel="apple-touch-icon" sizes="72x72" href="/bicons/apple-icon-72x72.png">
<link rel="apple-touch-icon" sizes="76x76" href="/bicons/apple-icon-76x76.png">
<link rel="apple-touch-icon" sizes="114x114" href="/bicons/apple-icon-114x114.png">
<link rel="apple-touch-icon" sizes="120x120" href="/bicons/apple-icon-120x120.png">
<link rel="apple-touch-icon" sizes="144x144" href="/bicons/apple-icon-144x144.png">
<link rel="apple-touch-icon" sizes="152x152" href="/bicons/apple-icon-152x152.png">
<link rel="apple-touch-icon" sizes="180x180" href="/bicons/apple-icon-180x180.png">
<link rel="icon" type="image/png" sizes="192x192"  href="/bicons/android-icon-192x192.png">
<link rel="icon" type="image/png" sizes="32x32" href="/bicons/favicon-32x32.png">
<link rel="icon" type="image/png" sizes="96x96" href="/bicons/favicon-96x96.png">
...
<link rel="stylesheet" href="/files/buildtime.css" type="text/css" />
<link rel='stylesheet' type='text/css' href='/files/fancybox.css' />
<link rel='stylesheet' type='text/css' href='/files/main_style.css%3F1422559220.css' title='wsite-theme-css' />
...
<style>
.wsite-background {background-image: url('files/structure.jpg') !important;background-repeat: no-repeat !important;background-position: 50% 50% !important;background-size: cover !important;background-color: transparent !important;background: inherit;}
		...
		<div id="header">
			<div id="sitename">
				<span class='wsite-logo'><a href='/'>
					<span id="wsite-title">StraboSpot</span></a>
				</span>
			</div>
		</div>
		<div id="navigation">
			...
			<ul class='wsite-menu-default'>
				...
				<li id='<?=$appactive?>'>
					<a href="#" data-membership-required="0" >Strabo-App</a>
					<div class='wsite-menu-wrap' style='display:none'>
						<ul class='wsite-menu'>
							...
							<li id=''><a href='/requestaccess'><span class='wsite-menu-title'>Request App Access</span></a></li>
