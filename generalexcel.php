				...
				foreach($rows as $row){
					...
					if($row->ecproject=="redux"){
						if($showage!=""){
							...
							$showonesigma=round($showonesigma/1000000,2);
						}else{
							$showonesigma="";
						}
					}
					...
					if($row->ecproject=="redux"){
						...
						$detritalmethod="U-Pb&nbsp;(ZIPS)";
					}elseif($row->ecproject=="uthhelegacy"){
						$detritalmethod="(U-Th)He";
					}
					...
					$sheet->write($y,6,$method,$formatwhite);
					...
					$sheet->write($y,7,$row->material,$formatwhite);
					$sheet->write($y,8,$showage,$formatwhite);
					$sheet->write($y,9,$showonesigma,$formatwhite);
					$sheet->write($y,10,$row->age_name,$formatwhite);					
					...
					$sheet->write($y,11,$row->geoobjecttype,$formatwhite);
					$sheet->write($y,12,$row->geoobjectclass,$formatwhite);
					$sheet->write($y,13,$row->collectionmethod,$formatwhite);
					$sheet->write($y,14,$row->analyst_name,$formatwhite);
					$sheet->write($y,15,$row->laboratoryname,$formatwhite);
					$sheet->write($y,16,$row->collector,$formatwhite);
					$sheet->write($y,17,$row->rocktype,$formatwhite);
					$sheet->write($y,18,$row->primarylocationname,$formatwhite);
					$sheet->write($y,19,$row->primarylocationtype,$formatwhite);
					$sheet->write($y,20,$row->locationdescription,$formatwhite);
					$sheet->write($y,21,$row->locality,$formatwhite);
					$sheet->write($y,22,$row->localitydescription,$formatwhite);
					$sheet->write($y,23,$row->country,$formatwhite);
					$sheet->write($y,24,$row->provice,$formatwhite);
					$sheet->write($y,25,$row->county,$formatwhite);
					$sheet->write($y,26,$row->cityortownship,$formatwhite);
					$sheet->write($y,27,$row->platform,$formatwhite);
					$sheet->write($y,28,$row->platformid,$formatwhite);
					$sheet->write($y,29,$row->originalarchivalinstitution,$formatwhite);
					$sheet->write($y,30,$row->originalarchivalcontact,$formatwhite);
					$sheet->write($y,31,$row->mostrecentarchivalinstitution,$formatwhite);
					$sheet->write($y,32,$row->mostrecentarchivalcontact,$formatwhite);
					...
					$sheet->writeUrl($y+1,0,"http://www.geochron.org/downloadfile.php?pkey=$row->sample_pkey","http://www.geochron.org/downloadfile.php?pkey=$row->sample_pkey");
