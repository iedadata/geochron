...
<xsl:stylesheet version="1.0"
	...
	<xsl:import href="EarthTimeOrgCommonTransformsicpms.xslt"/>
...
<div class="aboutpage">
<div class="headline">Aliquot Details
</div>
</div>

<div class="box_two">
<div class="aboutpage">
Sample Unique Identifier =  <xsl:value-of select="n:sampleIGSN"/>
<xsl:text> </xsl:text>
...
<div class="aboutpage">
Aliquot Unique Identifier =  <xsl:value-of select="n:aliquotIGSN"/>
<xsl:text> </xsl:text>
