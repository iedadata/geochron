...
*/
	...
	function show_my_form(mylat,mylon,mysqpkey,myzoom){
			...
			AjaxRequest.get(
				{
					'url':'mapquery.php'
					,'parameters':{ 'mylat':mylat, 'mylon':mylon, 'pkey':mysqpkey, 'zoom':myzoom }
					//,'onSuccess':function(req){ updatebox.value=req.responseText; }
					//,'onSuccess':function(req){ alert('Success!'); }
					//,'onSuccess':function(req) { document.getElementById(updatebox).innerHTML = req.url; }
	...
	function show_detail(mypkey,mylat,mylon,mysearch_query_pkey,myzoom){
			...
			AjaxRequest.get(
				{
					'url':'mapquery.php'
					,'parameters':{ 'sample_pkey':mypkey, 'mylat':mylat, 'mylon':mylon, 'pkey':mysearch_query_pkey, 'zoom':myzoom }
					//,'onSuccess':function(req){ updatebox.value=req.responseText; }
					//,'onSuccess':function(req){ alert('Success!'); }
					//,'onSuccess':function(req) { document.getElementById(updatebox).innerHTML = req.url; }
					,'onSuccess':function(req) { document.getElementById('results').innerHTML = req.responseText;  hideanimation(); }
