...
*/
	...
	function show_my_form(mylat,mylon,myzoom,showfig){
			...
			AjaxRequest.get(
				{
					'url':'usermapquery.php'
					,'parameters':{ 'mylat':mylat, 'mylon':mylon, 'zoom':myzoom, 'showfig':showfig }
	...
	function show_detail(mypkey,mylat,mylon,myzoom,myshowfig){
			...
			AjaxRequest.get(
				{
					'url':'usermapquery.php'
					,'parameters':{ 'sample_pkey':mypkey, 'mylat':mylat, 'mylon':mylon, 'zoom':myzoom, 'showfig':myshowfig }
					//,'onSuccess':function(req){ updatebox.value=req.responseText; }
					//,'onSuccess':function(req){ alert('Success!'); }
					//,'onSuccess':function(req) { document.getElementById(updatebox).innerHTML = req.url; }
					,'onSuccess':function(req) { document.getElementById('results').innerHTML = req.responseText;  hideanimation(); }
