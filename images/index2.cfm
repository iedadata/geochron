...
<body style="background-color:#dbd9cb">
<cfset session.script="index.cfm">
<div name="doesnothing" style="width:800px;margin:0 auto;
text-align:center;
  ...
  <div style="text-align:center;margin :0 auto;width:715px;height:290px;border:#4572b3 solid 1px; background-color:white;">
    <table width="715" cellspacing="0" cellpadding="0" border="0" style="border:none 1px cyan; padding: 0 0 0 0; margin:0 0 0 0;">
      <tr>
        ...
        <td align="right" valign="middle"><div style="height:65px">.</div>
		<div style="vertical-align:middle;height:130px"><img src="images/gc-itc-320.jpg" width="320" height="130" hspace="0" vspace="0" border="0" /></div>
		<div style="height:65px;width:100%;background-color:pink"><span style="vertical-align:baseline;text-align:right">caption.....</span></div>
